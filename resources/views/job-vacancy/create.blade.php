                ...
                <div class="mb-4">
                    ...
                    <select name="jobCategoryId" id="jobCategoryId" 
                        ...
                        @foreach($jobCategories as $jobCategory)
                            <option value="{{ $jobCategory->id }}" {{ old('job_categoryId') == $jobCategory->id ? 'selected' : '' }}>
                                {{ $jobCategory->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <!-- Job Description -->
                 <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="4"
                        ...
                        shadow-sm px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror   
                </div>
