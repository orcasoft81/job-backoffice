        ...
        <form action="{{ route('companies.store') }}" method="POST" >
            ...
            <div class="mb-4 p-6 bg-gray-50 border border-gray-100 rounded-lg shadow-sm">
                ...
                <div class="mb-4">
                    ...
                    <select name="industry" id="industry" class="{{ $errors->has('industry')?'outline-red-500':'outline-gray-300' }} outiline outiline-1 mt-1 block w-full rounded-md
                        shadow-sm px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" >
            ...
            <div class="mb-4 p-6 bg-gray-50 border border-gray-100 rounded-lg shadow-sm">
                ...
                <!-- owner password -->
                <div class="mb-4">
                    <label for="owner_password" class="block text-gray-700 font-semibold mb-2">Owner Password</label>
